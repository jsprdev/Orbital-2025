            ...
            {placeDetails ? (
                <View className="bg-white h-full gap-y-3">
                    ...
                    <View className="px-6 gap-y-1">
                        ...
                        <View>
                            {placeDetails.current_opening_hours?.weekday_text ? placeDetails.current_opening_hours?.weekday_text.map((line: string, idx: number) => {
                                        ...
                                        {hourRanges.map((range, i) => (
                                            <View key={i} className="flex-row">
                                                ...
                                                <View className="flex-1">
                                                    <Text className="text-sm text-black-500">{range}</Text>
                                                </View>
                                            </View>
                                         ))}
                                    </View>
                            ...
                            : <Text className="text-gray-500">No available information</Text>}
                        </View>
                    </View>
